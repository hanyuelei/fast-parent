...
/**
 * 
* @ClassName: SelectDictAttrProcessor  
* @Description: TODO(select标签)  
* @author hanyl
* @date 2019年7月3日 上午10:51:13  
*
 */
public class SelectDictAttrProcessor extends AbstractAttributeTagProcessor {
    ...
    public static final String SELECTED_ATTR_NAME= "mo-selected";  //默认选中
    public static final String EMPTY_ATTR_NAME= "mo-empty";//空选项 可做默认值用

	/*
	 * <select class="timo-search-select" name="imageType" id="imageType"
	 * fw:dict="IMAGE_STATUS" mo-selected="2" mo-empty="全部"></select>
	 */
